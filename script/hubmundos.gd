...
var datos_mundos = [
	{
		...
		"img": preload("res://assets/foto_logica.png"), # Asegúrate que esta imagen existe
		# IMPORTANTE: Esta ruta debe ser EXACTA al nombre de tu archivo
		"escena": "res://escenas/MenuNivelesLogica.tscn" 
	},
	{
		"titulo": "Mundo 2",
		"desc": "Próximamente...",
		"img": preload("res://assets/foto_fin.png"),
	...
	# Puedes copiar y pegar el bloque de arriba para tener 4 tarjetas y ver cómo queda el Grid
	{
		"titulo": "Mundo 3",
		"desc": "Próximamente...",
		"img": preload("res://assets/patronhierba.png"),
		"escena": ""
	},
	{
		"titulo": "Examen Final",
...
func _on_boton_volver_pressed():
	...
	get_tree().root.get_node("Main").change_scene_to_file("res://escenas/MenuPrincipal.tscn")
